...
"c903f7c0f0a7437dae32ce25d7c10a9e"
        ...
        private static void ApplyBracersOfArmorEnchantmentFixes()
        {
            ...
            //Main.Log("Applying Bracers Enchant Fixes");
        ...
        public static void KillIncorporealEnchant(ItemEntity e)
        {
        ...
        {
            //Main.Log("Applying Bracers Item FIxes");
            itemsTofix = itemsIdsToFix.Select(x => ResourcesLibrary.TryGetBlueprint<BlueprintItemEquipment>(x)).ToArray();
            foreach (BlueprintItemEquipment x in itemsTofix)
            {

                x.Enchantments.RemoveAll(IsKillable);
                //Main.LogPatch("Killed Extra Enchants on", x);
            }
